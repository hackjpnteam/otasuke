          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 xl:gap-20">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed text-base sm:text-lg">
                ショッピングセンターやモールなどの商業施設での買取催事を企画・運営いたします。宝石、貴金属、ブランド品、時計などの買取イベントを専門知識と経験を活かしてサポート。会場の手配から集客まで、成功する買取催事を実現いたします。
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed text-base sm:text-lg">
                ショッピングセンターやモールでの磁気治療器販売催事を企画・運営いたします。コリや血行を改善する効果により医療機器と認定済みの安全で効果的な交流磁気治療器の無料体験イベントを通じてお客様の健康をサポート。専門スタッフが丁寧な説明とアフターサービスを提供いたします。無理な売り込みはありませんのでご安心ください。
              </p>
            </motion.div>
          </div>
        </div>
